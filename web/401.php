<?php
// ~/Documents/ELIOT/web/401.php

// Set HTTP 401: Wajib agar browser tahu ini adalah error Unauthorized
http_response_code(401);

// Log error (optional)
error_log("[ELIOT 401] Unauthorized Access Attempt: " . ($_SERVER['REQUEST_URI'] ?? 'unknown') . " - " . date('Y-m-d H:i:s'));
...
<head>
    ...
    <title>401 - Akses Tidak Sah | ELIOT</title>
    
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
    
    <link rel="stylesheet" href="<?= $base_url ?>/public/assets/css/401.css">
</head>
<body>
        ...
        <div class="error-card">
            ...
            <div class="error-left">
                <div class="error-image">
                    ...
                    <i class="fas fa-lock fall-object-icon"></i>
                </div>
            </div>
            
            <div class="error-right">
                <div class="error-content">
                    <h1 class="mb-3">401 Unauthorized</h1>
                    <p class="lead text-secondary mb-4">
                        Anda tidak memiliki otorisasi (izin) untuk mengakses halaman ini.
                    </p>
                    <p class="text-secondary small">
                        Hal ini biasanya terjadi karena Anda belum login atau sesi Anda sudah kedaluwarsa. Silakan login kembali untuk melanjutkan.
                    </p>
                    ...
                    <div class="action-buttons mt-4">
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-sm-auto">
                                <a href="javascript:void(0)" onclick="goBackSafely()" class="btn btn-secondary-custom w-100">
    ...
    <script>
        ...
        // Fungsi kembali aman (sama seperti 404/500/400)
        function goBackSafely() {
            if (window.history.length > 1) {
                window.history.back();
            } else {
                // Fallback selalu ke halaman login
